...
import kr.co.popool.bblpayment.domain.dto.CouponDTO;
import kr.co.popool.bblpayment.domain.dto.PeriodCouponDTO;
...
public class PeriodCouponController {
    ...
    @PatchMapping("/items/periodCoupon/update/{periodCouponId}")
